...
window.addEventListener("load", function () {
	...
	jsonData=loadJSON('https://david-ellis.github.io/mini-projects/ucu-strike/unis_with_locs.json'); 
...
function makeTable(parent_id, index) {
	const info_items = ["Name", "Postcode", "Branch website", "Branch twitter", "Branch facebook"]
